...
const Gallery = () => {
    ...
    const images = [
        ...
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta01, size: 'small' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta02, size: 'small' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta03, size: 'small' },
