...
const Gallery = () => {
    ...
    const images = [
        ...
        { cat: 'Bodas', title: 'Preparativos', url: bodaPrevia08, size: 'small' },
        { cat: 'Bodas', title: 'Preparativos', url: bodaPrevia04, size: 'small' },
        ...
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePista08, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePista10, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePista13, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePista16, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePrevia01, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePrevia02, size: 'medium' },
        { cat: '15 Años', title: 'Detalles que Brillan', url: quincePrevia03, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFiesta01, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFiesta02, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFiesta03, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFiesta07, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFrios01, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFrios02, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFrios05, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionFrios07, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionMesa01, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionMesa02, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionMesa04, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta01, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta02, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta03, size: 'medium' },
        { cat: 'Ambientaciones', title: 'Estilo Creme', url: ambientacionTorta04, size: 'medium' },
        { cat: 'Tecnología', title: 'Pista de Baile', url: tecPista01, size: 'medium' },
    ];
